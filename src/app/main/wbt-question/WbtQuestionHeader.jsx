...
function WbtQuestionHeader() {
	...
	return (
		<div className="flex space-y-12 sm:space-y-0 flex-1 w-full items-center justify-between py-8 sm:py-16 px-16 md:px-24">
			...
			>
				<Typography className="text-24 md:text-32 font-extrabold tracking-tight">Questionare</Typography>
			</motion.span>
...
export default WbtQuestionHeader;
