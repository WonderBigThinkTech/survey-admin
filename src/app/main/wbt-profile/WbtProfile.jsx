...
import {Typography, Tabs, Tab, Box, Avatar} from '@mui/material';
...
import adminPng from './admin.jpg';
				...
				<div className="flex flex-col w-full">
					...
					<div className="flex flex-col flex-0 lg:flex-row items-center max-w-5xl w-full mx-auto px-32 lg:h-72">
						...
						<div className="flex flex-col items-center lg:items-start mt-16 lg:mt-0 lg:ml-32">
							<Typography className="text-lg font-bold leading-none">{userData?.name}</Typography>
							<Typography className="text-md leading-none">{userData?.role}</Typography>
						</div>
